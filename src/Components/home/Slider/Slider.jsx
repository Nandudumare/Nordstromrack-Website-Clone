...
<div className="newflash"><p >New Flash: Must-Have Sandals Up to 60% Off</p></div>
<p style={{fontWeight:"600",fontSize:"30px",textAlign:"center"}}>Online only</p>
     <div className="SliderApp">
       <Carousel breakPoints={breakPoints}>
       {filterData.map((item)=>{
           return (
...
const Spring = () => {
  return (
    ...
    <div className="Springcompo">
      <div className="Springimg"><img src='https://n.nordstrommedia.com/id/316b6242-fb9d-4e9f-a418-e3ce62a67b22.jpeg?h=555&w=804'></img>
       <div>
         <h2>Lancôme</h2>
      ...
      <div className="Springimg"><img src='https://n.nordstrommedia.com/id/fa4bc7a2-24fd-4338-a408-227419f47e61.jpeg?h=555&w=804'></img>
      <div>
...
const Springaccess = () => {
  return (
    ...
    <div className='springaccdiv'>
      <div className='springaccimg'><img src='https://n.nordstrommedia.com/id/51a1cabc-fd85-47e8-8284-d93bb49e06b3.jpeg?h=501&w=536'></img>
      <h3>New Balance, adidas & More</h3>
      <p>New kicks under $50.</p>
      </div>
      <div className='springaccimg'><img src="https://n.nordstrommedia.com/id/d6d1b793-6be3-4723-b51f-50b584cfd9a5.jpeg?h=501&w=536"></img>
      <h3>Max Studio, Pleione, Melloday & More</h3>
      <p>Spring tops from $19.97.</p>
      </div>
      <div className='springaccimg'><img src='https://n.nordstrommedia.com/id/e85d2408-8f1b-4ae0-86d9-675a0ad11f3e.jpeg?h=501&w=536'></img>
      <h3>Kurt Geiger London & More</h3>
